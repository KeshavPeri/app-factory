...
**This is the factory-level rough starting set.** Copy this file into each app repo and adjust
— a personal FPL app and a fitness planner shouldn't necessarily look alike. Rough is fine for
v0.1; making it genuinely distinctive per app is Phase 8's job, done from evidence after app #1
ships.
